...
import { HomeButton } from "@/components/HomeButton" // adjust path as needed
        ...
        <div className="grid gap-6">
          <div>
            ...
            <p className="text-muted-foreground">
              Manage your strata committee members and responsibilities.
            </p>
          </div>
            ...
            <TabsContent value="elections" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Information about the election process for the strata committee
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      The next committee election will be held at the Annual General Meeting on May
                      20, 2025.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Committee members are elected at each Annual General Meeting. Nominations can be submitted up
                      to 7 days before the meeting. The committee can have up to 9 members as specified in the
